export type DashboardWidgetType = "lineplot" | "loss_curve" | "learning_curve" | "feature_importance" | "barplot" | "area_chart" | "stacked_bar" | "scatterplot" | "starplot" | "histogram" | "boxplot" | "violin" | "heatmap" | "correlation_heatmap" | "confusion_matrix" | "data_grid" | "roc_curve" | "precision_recall_curve" | "calibration_curve" | "prediction_vs_actual" | "residual_plot" | "bubble_chart" | "parallel_coordinates" | "pie_chart" | "donut_chart" | "treemap" | "waterfall" | "progress" | "logs" | "kpi" | "gauge";
...
export function compatibleSourceKinds(type: DashboardWidgetType): DashboardSourceKind[] {
  ...
  if(["data_grid","roc_curve","precision_recall_curve","calibration_curve","prediction_vs_actual","residual_plot","feature_importance","bubble_chart","parallel_coordinates","pie_chart","donut_chart","treemap","waterfall"].includes(type))return ["table"];
