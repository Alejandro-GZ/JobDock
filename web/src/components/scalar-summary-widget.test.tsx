...
describe("Scalar summary widgets",()=>{
  ...
  it("renders custom gauge gradients",()=>{const {container}=render(<ScalarSummaryWidget source={source} widget={widget("gauge",{appearance:{schema_version:1,gradient:[{offset:0,color:"#16a34a"},{offset:1,color:"#dc2626"}]}})}/>);expect(container.querySelectorAll("defs stop")).toHaveLength(2);expect(container.querySelector("defs stop")?.getAttribute("stop-color")).toBe("#16a34a")});
});
