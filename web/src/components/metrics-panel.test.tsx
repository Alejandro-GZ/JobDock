...
describe("MetricsPanel live updates",()=>{
  ...
  it("switches independent dashboards without refetching an identical metric history",async()=>{
    ...
    await user.click(screen.getByRole("button",{name:"Collapse dashboard rail"}));expect(screen.getByRole("button",{name:"Expand dashboard rail"})).toBeTruthy();expect(screen.getByRole("tab",{name:"Validation"})).toBeTruthy();
