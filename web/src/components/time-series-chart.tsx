...
export function TimeSeriesChart({ title, points, markers = [], color = "var(--primary)", format = compact, summary: suppliedSummary, actions }: { title: string; points: SeriesPoint[]; markers?: ChartMarker[]; color?: string; format?: (value: number) => string; summary?: { last: number; min: number; max: number }; actions?: ReactNode }) {
