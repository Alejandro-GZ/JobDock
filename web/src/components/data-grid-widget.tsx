...
export function DataGridWidget({jobID,attemptID,widget,onUpdate}:{jobID:string;attemptID:string;widget:DashboardWidget;onUpdate:(widget:DashboardWidget)=>void}){
  ...
  const density=widget.appearance?.density??"normal",cellPadding=density==="compact"?"px-1 py-0.5":density==="comfortable"?"px-3 py-2.5":"px-2 py-1.5",striped=widget.appearance?.striped_rows??true;
