...
export type Build={id:string;owner_id:string;name:string;mode:"RAILPACK"|"DOCKERFILE";status:BuildStatus;source:BuildSource;oci_digest?:string;artifact_reference?:string;artifact_available:boolean;failure_reason?:string;created_at:string;started_at?:string;finished_at?:string;version:number};
...
export type LiveMetricSample={cursor:number;attempt_id:string;name:string;step?:number;value:number;captured_at:string};
