...
func TestOpenAPIDomainSchemasCoverJSONFields(t *testing.T) {
	...
	contracts := map[string]any{
		...
		"Build": domain.Build{}, "BuildSource": domain.BuildSource{}, "BuildEvent": domain.BuildEvent{}, "BuildPlan": domain.BuildPlan{}, "BuildAssignment": domain.BuildAssignment{}, "BuildWork": domain.BuildWork{},
