...
func compatibleDashboardSourceKinds(widgetType string) map[string]bool {
	...
	case "data_grid", "roc_curve", "precision_recall_curve", "calibration_curve", "prediction_vs_actual", "residual_plot", "feature_importance", "shap_summary", "bubble_chart", "parallel_coordinates", "pie_chart", "donut_chart", "treemap", "waterfall":
